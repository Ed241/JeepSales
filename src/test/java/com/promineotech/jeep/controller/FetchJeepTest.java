...
class FetchJeepTest extends FetchJeepTestSupport {
  ...
  class TestsThatDoNotPolluteTheApplicationContext extends FetchJeepTestSupport{
     ...
     */
    @Test
    void testThatJeepsAnErrorMessageisReturnedWhenAnUnknownTrimIsSupplied() {
      // Given: a valid model, trim, and URI
    ...
    void testThatJeepsAnErrorMessageisReturnedWhenAnInvalidTrimIsSupplied(String model, String trim,
        String reason) {
      // Given: a valid model, trim, and URI
  ...
  class TestsThatPolluteTheApplicationContext extends FetchJeepTestSupport{
     ...
     */
    @Test
    void testThatJeepsAnErrorMessageisResultsInA500Status() {
      // Given: a valid model, trim, and URI
