...
public class DefaultJeepOrderDao implements JeepOrderDao {
  ...
  public Optional<Customer> fetchCustomer(String customerId) {
    ...
    return Optional.ofNullable(jdbcTemplate.query(sql, params, new CustomerResultSetExctractor()));
  }
   ...
   *
   */
  class CustomerResultSetExctractor implements ResultSetExtractor<Customer> {
